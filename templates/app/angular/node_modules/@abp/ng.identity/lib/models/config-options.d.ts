...
export declare type IdentityEntityActionContributors = Partial<{
...
export declare type IdentityToolbarActionContributors = Partial<{
...
export declare type IdentityEntityPropContributors = Partial<{
...
export declare type IdentityCreateFormPropContributors = Partial<{
...
export declare type IdentityEditFormPropContributors = Partial<{
