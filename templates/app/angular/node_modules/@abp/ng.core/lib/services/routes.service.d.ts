...
export declare abstract class AbstractNavTreeService<T extends ABP.Nav> extends AbstractTreeService<T> implements OnDestroy {
    ...
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<AbstractNavTreeService<any>, never>;
    static ɵprov: ɵngcc0.ɵɵInjectableDeclaration<AbstractNavTreeService<any>>;
}
export declare class RoutesService extends AbstractNavTreeService<ABP.Route> {
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<RoutesService, never>;
}
export declare class SettingTabsService extends AbstractNavTreeService<ABP.Tab> {
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<SettingTabsService, never>;
}
