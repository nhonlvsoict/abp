...
export declare class ModalComponent implements OnInit, OnDestroy, DismissableModal {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<ModalComponent, [null, null, { optional: true; }, null, null]>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<ModalComponent, "abp-modal", never, { "centered": "centered"; "modalClass": "modalClass"; "size": "size"; "options": "options"; "suppressUnsavedChangesWarning": "suppressUnsavedChangesWarning"; "visible": "visible"; "busy": "busy"; }, { "visibleChange": "visibleChange"; "init": "init"; "appear": "appear"; "disappear": "disappear"; }, ["abpHeader", "abpBody", "abpFooter", "abpSubmit", "abpClose"], ["*"]>;
}
