...
export declare class PropDataDirective<L extends PropList<any>> extends PropData<InferredData<L>> implements OnChanges, OnDestroy {
    ...
    ngOnChanges(): void;
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<PropDataDirective<any>, never>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<PropDataDirective<any>, "[abpPropData]", ["abpPropData"], { "propList": "abpPropDataFromList"; "record": "abpPropDataWithRecord"; "index": "abpPropDataAtIndex"; }, {}, never>;
}
declare type InferredData<L> = PropData<InferredRecord<L>>;
declare type InferredRecord<L> = L extends PropList<infer R> ? R : never;
export {};

//# sourceMappingURL=prop-data.directive.d.ts.map