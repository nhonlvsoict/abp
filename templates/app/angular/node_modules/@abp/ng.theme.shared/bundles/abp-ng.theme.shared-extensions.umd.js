(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function mapEntitiesToContributors(configState, resource) {
        return rxjs.pipe(operators.switchMap(function (entities) { return rxjs.zip(selectLocalization(configState), selectEnums(configState)).pipe(operators.map(function (_a) {
