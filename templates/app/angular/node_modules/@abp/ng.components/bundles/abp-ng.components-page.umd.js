(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var PagePartDirective = /** @class */ (function () {
        function PagePartDirective(templateRef, viewContainer, renderLogic, injector) {
            ...
            this.render = function (shouldRender) {
                if (shouldRender && !_this.hasRendered) {
                    _this.viewContainer.createEmbeddedView(_this.templateRef);
                    _this.hasRendered = true;
                }
                else if (!shouldRender && _this.hasRendered) {
                    _this.viewContainer.clear();
                    _this.hasRendered = false;
                }
            };
        }
        Object.defineProperty(PagePartDirective.prototype, "abpPagePart", {
            set: function (type) {
                this.type = type;
        ...
        PagePartDirective.prototype.ngOnChanges = function (_b) {
        ...
        PagePartDirective.prototype.shouldRender = function (type) {
            if (this.renderLogic) {
                var willRender = this.renderLogic.shouldRender(type);
                return willRender instanceof rxjs.Observable ? willRender : rxjs.of(willRender);
            }
            return rxjs.of(true);
        };
        PagePartDirective.prototype.createRenderStream = function (type) {
            this.clearSubscription();
            this.subscription = this.shouldRender(type).subscribe(this.render);
        };
        PagePartDirective.prototype.clearSubscription = function () {
    ...
    exports.PAGE_RENDER_STRATEGY = PAGE_RENDER_STRATEGY;
    exports.PageBreadcrumbContainerComponent = PageBreadcrumbContainerComponent;
    exports.PageComponent = PageComponent;
    exports.PageModule = PageModule;
    exports.PagePartDirective = PagePartDirective;
    exports.PageTitleContainerComponent = PageTitleContainerComponent;
    exports.PageToolbarContainerComponent = PageToolbarContainerComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=abp-ng.components-page.umd.js.map
