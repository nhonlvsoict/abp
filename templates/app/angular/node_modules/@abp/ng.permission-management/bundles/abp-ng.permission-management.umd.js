    ...
    var PermissionManagementComponent = /** @class */ (function () {
        ...
        PermissionManagementComponent.prototype.submit = function () {
            ...
            this.store
                ...
                .pipe(operators.switchMap(function () { return _this.shouldFetchAppConfig()
                ? _this.appConfigService.get().pipe(operators.tap(function (res) { return _this.configState.setState(res); }))
                : rxjs.of(null); }), operators.finalize(function () { return (_this.modalBusy = false); }))
                .subscribe(function () {
                _this.visible = false;
            });
        };
