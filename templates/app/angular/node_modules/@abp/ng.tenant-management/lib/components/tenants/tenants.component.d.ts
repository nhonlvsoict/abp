...
export declare class TenantsComponent implements OnInit {
    ...
    constructor(list: ListService<GetTenantsInput>, injector: Injector, confirmationService: ConfirmationService, tenantService: TenantService, fb: FormBuilder, store: Store);
    ngOnInit(): void;
    ...
    sort(data: any): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<TenantsComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<TenantsComponent, "abp-tenants", never, {}, {}, never, never>;
}
export {};

//# sourceMappingURL=tenants.component.d.ts.map